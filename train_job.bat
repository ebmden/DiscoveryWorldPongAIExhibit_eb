...
singularity exec --nv /data/containers/msoe-tensorflow-20.07-tf2-py3.sif python3 -c "import tensorflow as tf; print(tf.reduce_sum(tf.random.normal([1000, 1000])))"
